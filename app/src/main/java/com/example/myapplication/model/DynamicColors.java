...
import com.example.myapplication.model.DynamicColors;

public class DynamicColors implements Serializable {
    ...
    // Constructor
    public DynamicColors(Integer dynamicColorId, String dynamicColorCode, String dynamicColorName,
